...
{
    class YoutubeVMM: INotifyPropertyChanged
    {
        ...
        private const string ApiKey = "AIzaSyBtc8gM2Aped4tzkIw_avG8xtTRXSAaAXQ";
         ...
         private string apiUrlForVideosDetails = "https://www.googleapis.com/youtube/v3/search?part=snippet&q=spongebob&maxResults=1&order=rating" + "&key=" + ApiKey;
        ...
        public async Task InitDataAsync()
        {
            ...
            YoutubeItems = await GetVideosAsync();
